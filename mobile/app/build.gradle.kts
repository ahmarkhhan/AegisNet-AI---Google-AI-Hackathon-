...
android {
    namespace = "com.aegisnet.mobile"
    compileSdk = 34
    buildToolsVersion = "34.0.0"

    defaultConfig {
        applicationId = "com.aegisnet.mobile"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
    ...
    buildTypes {
        ...
        release {
            ...
            buildConfigField("String", "BASE_URL", "\"https://api.aegisnet.ai/\"")
        }
    }
...
dependencies {
    ...
    // Google Gemini AI SDK (On-Device AI Agents)
